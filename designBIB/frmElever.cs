...
namespace designBIB
{
    public partial class FrmElever : MetroForm
    {
        ...
        private static DataTable Loader()
        {
        ...
        private static DataTable WorksheetToDataTable(ExcelWorksheet ws, bool hasHeader = true)
        {
        ...
        {
            ((DataTable) dataGridView1.DataSource).DefaultView.RowFilter = $"Id LIKE '%{textBox1.Text}%'";
        }
        ...
        private void dataGridView1_CellValidating(object sender, DataGridViewCellValidatingEventArgs e)
        {
            ...
            else if (string.IsNullOrEmpty(e.FormattedValue.ToString()))
            {
                ...
                MessageBox.Show(
                    @"Det går inte att lägga till en användare ut en unik identifierare (Schoolsoft användarnamn)",
                    @"Error",
